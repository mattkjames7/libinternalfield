...
/* list of model names */
std::vector<std::string> modelNames = {	"jpl15ev",
								"sha",
								"isaac",
								"jpl15evs",
								"u17ev",
...
std::map<std::string,unsigned char*> modelMap = {	{"jpl15ev",&_binary_jpl15ev_bin_start},
										...
										{"ness1975",&_binary_ness1975_bin_start},
